-- 💻 LSP & Completion - Mason, lspconfig, cmp, trouble for elite coding
...
return {
  ...
  -- 🌉 Mason-lspconfig bridge - Auto-install LSP servers
  {
  ...
  -- ⚙️ LSP Configuration - The heart of language support
  {
    ...
    config = function()
      ...
      -- 🎯 Common on_attach function with all LSP keymaps
      local on_attach = function(client, bufnr)
        ...
        -- 🎨 Formatting (0.11+ async formatting for snappier LSP)
  ...
  -- 🎯 Completion engine - Smart autocompletion
  {
    "hrsh7th/nvim-cmp",
    event = "InsertEnter",
    dependencies = {
  ...
  -- ⚠️ Trouble - Better diagnostics and quickfix
  {
    "folke/trouble.nvim",
